...
<div class="container mx-auto">
	<div class="flex">
		<div class="w-full lg:w-8/12 mx-auto intro__cart">
			...
			<h3 class="title--4">
				BUY MORE PATTERNS AND SAVE!
			</h3>

			<ul>
				<li>Buy 2 patterns, save 15% off your total order.</li>
				<li>Buy 3 patterns, save 20% off your total order.</li>
				<li>Buy 4 patterns, save 25% off your total order.</li>
				<li>
					Buy 5 or more patterns, save 30% off your total order.</li>
